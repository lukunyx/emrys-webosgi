...
public interface LicenseType {
	...
	/**
	 * Get the identity name of this license type, should be 6 chars string. If
	 * less 6 chars, a 'n' char will be appended. Otherwise, the more chars will
	 * be removed in use.
	 * 
	 * @return
	 */
	...
	/**
	 * @param code
	 * @return not null, dedicating this code is for this license type and can
	 *         be parsed successfully.
	 */
	String parseLicenseCode(String code);

	/**
	 * Whether this license is valid. If validate failed for any cause, a
	 * LicenseException will be threw indicating this license illegal. If no
	 * LicenseException occur, this license is valid then.
	 * 
	 */
