...
public class HandlerActivator<T> implements BundleActivator {
	 ...
	 * 
	 * @param protocols
	 *            array of handled protocols. Cannot be null.
	 * @param pid
	 *            service pid. Cannot be null.
	 * @param connectionFactory
	 *            protocol specific connection factory. Cannot be null
	 * 
	 * @throws NullArgumentException
	 *             if any of the paramters is null
	 */
	public HandlerActivator(final String[] protocols, final String pid,
		...
		NullArgumentException.validateNotNull(connectionFactory,
				"Connection factory");
	...
	/**
	 * Registers Handler as a wrap: protocol stream handler service and as a
	 * configuration managed service if possible.
	 * 
	 * @param bundleContext
	 *            the bundle context.
	 * 
	...
	private void registerHandler() {
		...
		m_handlerReg = m_bundleContext.registerService(
				URLStreamHandlerService.class.getName(), new Handler(), props);
	...
	synchronized void setResolver(final PropertyResolver propertyResolver) {
		...
		m_configuration = m_connectionFactory
				.createConfiguration(propertyResolver);
	}
	...
	private class Handler extends AbstractURLStreamHandlerService {
		...
		public URLConnection openConnection(final URL url) throws IOException {
			return m_connectionFactory.createConection(m_bundleContext, url,
					m_configuration);
		}
