...
public class DefaultLicenseAttribute implements LicenseAttribute {
	 ...
	 */
	public DefaultLicenseAttribute(String name, String displayName, String defaultValue,
			String description, boolean isRequired, boolean isRuntimeGenerated, int valueBytesCount) {
		this.name = name;
	 ...
	 * 
	 * @see
	 * org.emrys.common.license.LicenseAttribute#isRuntimeGenerated()
	 */
