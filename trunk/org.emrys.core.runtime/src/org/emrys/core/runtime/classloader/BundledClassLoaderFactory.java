...
public class BundledClassLoaderFactory {
	 ...
	 * @return
	 */
	public static URLClassLoader getBundledJspUrlClassLoader(Bundle bundle) {
		URLClassLoader resLoader = wbJspUrlClassLoaders.get(bundle);
		if (resLoader == null) {
			ClassLoader threadCtxClassloader = Thread.currentThread()
					.getContextClassLoader();
			resLoader = new BundleJspClassLoader(bundle, threadCtxClassloader);
