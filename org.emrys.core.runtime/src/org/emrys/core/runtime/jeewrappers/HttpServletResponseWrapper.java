...
public class HttpServletResponseWrapper implements IBuffferdServletResponse,
		...
		/* synchronized (wrappers) */{
			...
			if (res instanceof HttpServletResponse) {
				...
				HttpServletResponseWrapper topWrapper = (HttpServletResponseWrapper) FwkRuntime
						...
						.get(OSGiJEEContainer.THREAD_V_RESPONSE);
	...
	public void addCookie(Cookie cookie) {
		if (wrappedResponse != null)
			...
			// Fix the bug: set Cookie type back to the original ServletResponse
			// may cause Class
			// cast excetpion. Edit the HttpServletResponseAdapter.addCookie()'s
			// argument type as
			// Object.
